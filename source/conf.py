...
html_static_path = ['apidoc_static']
...
texinfo_documents = [
  ('index', 'documentation', u'documentation Documentation',
   u'Monami', 'documentation', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_author = u'Monami'
epub_publisher = u'Monami'
epub_copyright = u'2015, Monami'
